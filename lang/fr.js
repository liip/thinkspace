export default {
  ...
  space: {
    available: {
      body:
        'Nous sommes à votre disposition pour répondre à vos questions ou visiter les lieux.',
    },
    notAvailable: {
      short: 'Indisponible',
      long: 'Cet espace est actuellement indisponible',
      body:
  ...
  plan: {
    rooms: {
      ...
      kitchen: 'Espace cuisine et repas',
      liip: 'Open space utilisé par Liip',
    },
  },
  footer: {
    liip: 'Une initiative de {0}',
  },
};
